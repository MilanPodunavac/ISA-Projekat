...
INSERT INTO ADMIN (id, email, password, enabled, first_name, last_name, phone_number, main_admin, password_changed, location_id, role_id) VALUES (6, 'milan@gmail.com', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra', true, 'Milan', 'Milić', '123456789', false, true, 6, 1);
...
INSERT INTO CLIENT (id, email, password, enabled, first_name, last_name, phone_number, banned, penalty_points, loyalty_points, category_id, location_id, role_id) VALUES (10, 'milovan@gmail.com', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra', true, 'Milovan', 'Ljubicic', '111111111', false, 0, 0, 1, 19, 2);

INSERT INTO ACCOUNT_DELETION_REQUEST (text, user_id, version, processed, accepted) VALUES ('molim te', 5, 0, false, false);
...
INSERT INTO FISHING_TRIP (cost_per_day, description, equipment, max_people, name, percentage_instructor_keeps_if_reservation_cancelled, rules, fishing_instructor_id, location_id, schedule_changed, version) VALUES (100, 'opis', 'oprema', 5, 'naziv', 0, 'pravila', 5, 10, 0, 0);
INSERT INTO FISHING_TRIP (cost_per_day, description, equipment, max_people, name, percentage_instructor_keeps_if_reservation_cancelled, rules, fishing_instructor_id, location_id, schedule_changed, version) VALUES (200, 'opis2', 'oprema2', 10, 'naziv2', 30, 'pravila2', 5, 11, 0, 0);
INSERT INTO FISHING_TRIP (cost_per_day, description, equipment, max_people, name, percentage_instructor_keeps_if_reservation_cancelled, rules, fishing_instructor_id, location_id, schedule_changed, version) VALUES (150, 'opis3', 'oprema3', 3, 'naziv3', 20, 'pravila3', 9, 12, 0, 0);
...
INSERT INTO COMPLAINT (description, client_id, sale_entity_id, version, responded) VALUES ('nije kao u opisu usluge', 2, 1, 0, false);

INSERT INTO COMPLAINT_FISHING_INSTRUCTOR (description, client_id, fishing_instructor_id, version, responded) VALUES ('loš odnos prema klijentu', 2, 5, 0, false);