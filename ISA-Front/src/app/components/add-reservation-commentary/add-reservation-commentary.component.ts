...
@Component({
    selector: 'app-add-reservation-commentary',
    templateUrl: './add-reservation-commentary.component.html',
    styleUrls: ['./add-reservation-commentary.component.scss']
})
export class AddReservationCommentaryComponent implements OnInit {
    ...
    public onSubmit(): void {
        ...
        this.fishingTripService.addReservationCommentary(id, commentaryRequest).subscribe({
            next: data => {
